...
<?
  ...
  $answerkind='<p>';
	$answerkind.='<table align="center" width="1000" border="0" cellpadding="2" cellspacing="0">';
	$answerkind.='<tr>';
  $answerkind.='	<td align="center" style="border-top-style:solid;border-top-width:1px;border-top-color:black;border-bottom-style:solid;border-bottom-width:1px;border-bottom-color:black;border-left-style:solid;border-left-width:1px;border-left-color:black;font-weight:bold;text-align:center;' . ( $_GET["sort".$n]=="" ? "background-color:#7088AD" : "background-color:#cccccc;" ) . '">';
  ...
  $answerkind.='	<td align="center" style="border-top-style:solid;border-top-width:1px;border-top-color:black;border-bottom-style:solid;border-bottom-width:1px;border-bottom-color:black;border-left-style:solid;border-left-width:1px;border-left-color:black;font-weight:bold;text-align:center;' . ( $_GET["sort".$n]=="" ? "background-color:#7088AD;" : "background-color:#cccccc;" ) . '">';
	...
	while($drp=mysql_fetch_row($dsp))
	{
		  ...
		  {
			  $answerkind.='<tr>';
				$answerkind.='	<td align="center" style="border-bottom-style:dashed;border-bottom-width:1px;border-bottom-color:black;background-color:white;border-left-style:solid;border-left-width:1px;border-left-color:white;">';
				$answerkind.='	'.$q_out.'</td>';
				$answerkind.='	<td align="center" style="border-bottom-style:dashed;border-bottom-width:1px;border-bottom-color:black;background-color:white;border-left-style:solid;border-left-width:1px;border-left-color:white;">';
				$answerkind.='	'.$drp[3].'</td>';
        if(strcmp($drp[6],"YES")==0)
				...
				{
					$answerkind.='	<td align="center" style="border-bottom-style:dashed;color:red;border-bottom-width:1px;border-bottom-color:black;background-color:white;border-left-style:solid;border-left-width:1px;border-left-color:white;">';
				}
				$answerkind.='	'.$drp[4].'</td>';
				$answerkind.='	<td align="center" style="border-bottom-style:dashed;border-bottom-width:1px;border-bottom-color:black;background-color:white;border-left-style:solid;border-left-width:1px;border-left-color:white;">';
				$answerkind.='	'.$drp[5].'</td>';
		  ...
		  {
		  	$answerkind.='<tr>';
				$answerkind.='	<td align="center" style="border-bottom-style:dashed;border-bottom-width:1px;border-bottom-color:black;background-color:#E8E8E8;border-left-style:solid;border-left-width:1px;border-left-color:white;">';
				$answerkind.='	'.$q_out.'</td>';
				$answerkind.='	<td align="center" style="border-bottom-style:dashed;border-bottom-width:1px;border-bottom-color:black;background-color:#E8E8E8;border-left-style:solid;border-left-width:1px;border-left-color:white;">';
				$answerkind.='	'.$drp[3].'</td>';
				if(strcmp($drp[6],"YES")==0)
				...
				{
					$answerkind.='	<td align="center" style="border-bottom-style:dashed;color:red;border-bottom-width:1px;border-bottom-color:black;background-color:#E8E8E8;border-left-style:solid;border-left-width:1px;border-left-color:white;">';
				}
				$answerkind.='	'.$drp[4].'</td>';
				$answerkind.='	<td align="center" style="border-bottom-style:dashed;border-bottom-width:1px;border-bottom-color:black;background-color:#E8E8E8;border-left-style:solid;border-left-width:1px;border-left-color:white;">';
				$answerkind.='	'.$drp[5].'</td>';
...
//	$b->RenderTemplateTop();
?>
  <p><br><br>If the font color of the user answers is red, it represents that the answer is wrong.</p>
<?
  echo($answerkind);
