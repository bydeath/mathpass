...
{
	window.external.AddFavorite(document.location,"MathPass - Problems Assuring Student Success");
}
...
{
	GetBrowserElement("td_printView").style.display="none";
	GetBrowserElement("td_standardView").style.display="";
	GetBrowserElement("ss_static").href="globals.print.css";
	window.print();
}
function StandardizeTemplate()
{
	GetBrowserElement("td_standardView").style.display="none";
	GetBrowserElement("td_printView").style.display="";
	GetBrowserElement("ss_static").href="globals.css";
}
...
function SettleFontSize()
{
	var x=GetBrowserElement("txt_previewFontSize").value;
	GetBrowserElement("ss_dynamic").href="dynamicFontSize.php?size=" + x;
	GetBrowserElement("txt_previewFontSize").value=x;
	HideLayover("fontSize");
}
...
function MainMenuClick(index)
{
    ...
    case 17 :
		...
		case 19 :
			...
			break;
		case 20 :
			link="exportgrade.php";
			break;
		case 21 :
			link="admindirect.php";
			break;
		case 22 :
			link="goback.php";
			break;
		case 23 :
			link="correctRate.php";
			break;
		case 24 :
			link="correctRateTeacher.php";
			break;
	}
	if(link!=null)
	{
