...
//      var xd = new ActiveXObject("MSXML2.DOMDocument.5.0");
//      // Uncomment the following line to use MSXML 5.0
//      // var xd = new ActiveXObject("MSXML2.DOMDocument.5.0");
//    }
//    catch(e) 
//    { alert("DOM document not created. Check MSXML version used in createXmlDomDocument."); return;
//    }
//    return xd;
}
...
var xmlDoc =  createXmlDomDocument();
   ...
   if ( xmlDoc.loadXML(codeStr) )
     { 
//  	alert(xmlDoc.documentElement.xml);
     	 mathmlToInfix(xmlDoc.documentElement);
//  	alert(outmathml);
   }
}
    ...
    {   
       if ( node.tagName.match(/apply$/) || node.tagName.match(/reln$/) )
        {   
          ...
          for (var i=0; i < children.length; i++)
           {    if ( children[i].nodeType == 1 ) 
	         ...
	         if (  children[argStart].tagName.match(/ci$/)|| children[argStart].tagName.match(/cn$/)||  children[argStart].tagName.match(/mstyle$/)||  children[argStart].tagName.match(/apply$/) ) 
        ...
        { 
       	 ...
       	 if ( node.tagName.match(/ci$/) || node.tagName.match(/fn$/) )
        { 
