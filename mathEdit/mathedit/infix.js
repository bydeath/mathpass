			...
			case 1:	// Token is string
		        ...
		        case "root" :
						...
						case "cbrt" :
							...
							subNode = mathml(xmlDoc);
							Node.appendChild(subNode);
							var nNode1=createElement1(xmlDoc,"mn");
							var Text1 = xmlDoc.createTextNode("3")
					    nNode1.appendChild(Text1);
							Node.appendChild(nNode1);
							Current.appendChild(Node);
							break;
						case "ftrt" :
							Node = createElement1(xmlDoc,"mroot");
							...
							Node.appendChild(subNode);
							var nNode1=createElement1(xmlDoc,"mn");
							var Text1 = xmlDoc.createTextNode("4")
					    nNode1.appendChild(Text1);
							Node.appendChild(nNode1);
							Current.appendChild(Node);
							break;
...
function convertToPresentDOM(str,xmlDoc)
{
	...
	var str= str.replace(/\)(\w+)/gi,")*$1");
	var str= str.replace(/x\(/gi,"x*(");
	var str= str.replace(/y\(/gi,"y*(");
	Expression = new String(str);
	reset();
	TList = new Array();
	while ((End < Expression.length)&&(ErrorCode >= 0)) {
